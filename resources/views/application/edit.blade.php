<x-app-layout>
        ...
        <div class="w-full sm:w-4/12 mx-auto">
            @forelse($errors->all() as $error)
                <div id="alert-border-1"
                     class="flex items-center p-4 mb-4 text-yellow-800 border-t-4 border-yellow-300 bg-yellow-50 dark:text-yellow-400 dark:bg-yellow-800 dark:border-yellow-800"
                     role="alert">
    ...
    @endif
    <div class="{{$errors->any()?:'py-12'}} w-full sm:w-4/12 mx-auto">
