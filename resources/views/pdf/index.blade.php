...
<div class=" flex border border-gray-700 my-5">
    <div class=" w-fit px-10 py-10 border-gray-700">
        <img class="mx-auto block text-center justify-center" width="100" height="100" alt="utm logo" src="{{Storage::url('images/utm.png')}}"/>
    </div>
    ...
    <div class="text-left py-10 px-5 align-middle">
        <div>Form No.: <strong>UTM/AMD/02</strong></div>
        <div>Edition: <strong>3</strong></div>
        <div>Effective Date: <strong>1/9/2022</strong></div>
        <div>Page(s): 2</div>
    </div>
</div>
...
<div class="section">
    ...
    <div class="flex text-center align-middle justify-center">
        ...
        <input type="text" class="w-2/3 border-2 border-gray-500 p-2 rounded-md w-1/2 focus:border-teal-500 focus:outline-none" id="full-name" name="full-name">
    </div>
    <div class="flex text-center align-middle justify-center">
        <label class="block m-auto w-1/3" for="full-name">ID/PASSPORT:</label>
        <input type="text" class="block m-auto w-2/3" id="full-name" name="full-name">
    </div>
    <div class="flex text-center align-middle justify-center">
    ...
    <form action="/submit-deferment-form" method="post">
        <div class="form-section">
            ...
            <div class="checkbox-group mt-4 flex justify-between w-8/12 m-auto">
                <label><input type="checkbox" name="deferred-before" value="yes"> Yes, I have deferred my study before.</label>
                <label><input type="checkbox" name="deferred-before" value="no"> No, I have not deferred my study before.</label>
            </div>
            <div class="w-full flex mt-5 mx-auto">
                <div class="w-1/2 mx-3">
                    ...
                    <input type="text" id="previous-defer-session" name="previous-defer-session" placeholder="e.g., Sem 1-2017/2018">

                </div>
                <div class="w-1/2 mx-3">
                    <label for="wish-defer-session">I wish to defer my study during Session/Semester:</label>
                    <input type="text" id="wish-defer-session" name="wish-defer-session" placeholder="e.g., Sem 1-2018/2019">
                </div>
            </div>
            ...
            <div class="checkbox-group grid grid-cols-3 gap-5">
                <label><input type="checkbox" name="reason-for-defer" value="financial-difficulties"> Financial Difficulties</label>
                <label><input type="checkbox" name="reason-for-defer" value="personal-matters"> Personal Matters</label>
                <label><input type="checkbox" name="reason-for-defer" value="health-problem"> Health Problem</label>
                <label><input type="checkbox" name="reason-for-defer" value="university-nation-interests"> University/Nation Interests</label>
                <label><input type="checkbox" name="reason-for-defer" value="others"> Others (Please Specify)</label>
            </div>
            <textarea id="reason-for-defer-specify" name="reason-for-defer-specify" rows="4" placeholder="If others, please specify..."></textarea>
            <div class="form-section">
                ...
                <div class="grid grid-cols-4 gap-1 my-5">
                    <div class="">
                        <label><input type="checkbox" id="student-agreement" name="student-agreement" value="agree"> Agree</label>
                    </div>
                    <label for="declaration-date">Date:</label>
                </div>
            </div>
        </div>
        <div class="form-section">
            ...
            <div class="w-full flex my-5">
                ...
                <div class=" w-4/6 m-auto flex">
                    <label class="w-1/3"><input type="checkbox" name="supervisor-recommendation" value="recommended"> Recommended</label>
                    <label class="w-1/3"><input type="checkbox" name="supervisor-recommendation" value="not-recommended"> Not Recommended</label>
                </div>
            </div>
            <label for="supervisor-comments">Supervisor’s Comments:</label>
            <textarea id="supervisor-comments" name="supervisor-comments" rows="3" placeholder="Comments by Supervisor..."></textarea>
            <div class="flex justify-between">
                <label class="w-3/12" for="">Date:</label>
            </div>
        </div>
        <div class="form-section">
            ...
            <div class="w-full flex my-5">
                ...
                <div class=" w-4/6 m-auto flex">
                    <label class="w-1/3"><input type="checkbox" name="supervisor-recommendation" value="recommended"> Approved</label>
                    <label class="w-1/3"><input type="checkbox" name="supervisor-recommendation" value="not-recommended"> Not Approved</label>
                </div>
            </div>

            <label for="faculty-comments">Comments:</label>
            <textarea id="faculty-comments" name="faculty-comments" rows="3" placeholder="Comments by Assoc. Chair/Director or Coordinator..."></textarea>
            <div class="flex justify-between">
                <label class="w-3/12" for="">Date:</label>
            </div>
        </div>
        <div class="form-section">
            ...
            <textarea id="officer-comments" name="officer-comments" rows="3" placeholder="Comments by UTM International Office..."></textarea>
            <div class="flex justify-between">
                <label class="w-3/12" for="">Date:</label>
            </div>
        </div>
        <div class="form-section">
            ...
            <div class="w-full flex my-5">
                ...
                <div class=" w-4/6 m-auto flex">
                    <label class="w-1/3"><input type="checkbox" name="supervisor-recommendation" value="recommended"> Deferment Granted</label>
                    <label class="w-1/3"><input type="checkbox" name="supervisor-recommendation" value="not-recommended"> Deferment Denied</label>
                </div>
            </div>
            <label for="academic-office-comments">Comments:</label>
            <textarea id="academic-office-comments" name="academic-office-comments" rows="3" placeholder="Comments by Faculty Academic Office..."></textarea>
            <div class="flex justify-between">
                <label class="w-3/12" for="">Date:</label>
            </div>
        </div>
